...
public class GameManagerParejasLvl2 : MonoBehaviour

{
    ...
    void Start()
    {
        ...
        for (int i = 0; i <= GameManager.m_CurrentToMinigame[3]; i++)
        {
    ...
    public void InstantiatePairs()
    {
        ...
        if (GameManager.m_CurrentToMinigame[3] > 0 && m_Points.Length > GameManager.m_CurrentToMinigame[3] - 1)
            m_Points[GameManager.m_CurrentToMinigame[3] - 1].GetComponent<Image>().sprite = m_CompletedPoint;
    ...
    IEnumerator WaitSeconds(float seconds)
    {
        ...
        if (!repeating)
        {
            if (m_Points.Length > GameManager.m_CurrentToMinigame[3] - 1)
                GameManager.SumPointToMinigame(3);
            if (GameManager.m_CurrentToMinigame[3] > 0 && m_Points.Length > GameManager.m_CurrentToMinigame[3] - 1)
                m_Points[GameManager.m_CurrentToMinigame[3] - 1].GetComponent<Image>().sprite = m_CompletedPoint;
            if (!PaquetePalabrasParejas.GetInstance("2").acabado)
            {
            ...
            switch (_numofPairs)
            {
                case 2:
                    if (_firstTime)
                    {
                        ...
                        horizontal2Arriba[_currentPair].GetComponent<PairsLvl2>().nombre = l_Pairs[l_RandomPair].palabraActual;

                        horizontal2Arriba[_currentPair].GetComponent<PairsLvl2>().texto.text = l_Pairs[l_RandomPair].palabraActual;

                        horizontal2Arriba[_currentPair].GetComponent<PairsLvl2>().color = l_Pairs[l_RandomPair].color;
                        ...
                        if (GameManager.configuration.palabrasConArticulo)
                        {
                            ...
                            {
                                horizontal2Arriba[_currentPair].GetComponent<PairsLvl2>().articulo = l_Pairs[l_RandomPair].actualArticulo;
                                horizontal2Arriba[_currentPair].GetComponent<PairsLvl2>().audioArt = l_Pairs[l_RandomPair].GetAudioArticulo();
                                horizontal2Arriba[_currentPair].GetComponent<PairsLvl2>().onlyArt = l_Pairs[l_RandomPair].onlyArticulo;

                            }
                        }
                        horizontal2Arriba[_currentPair].GetComponent<PairsLvl2>().Init();


                        horizontal2Arriba[_currentPair].GetComponent<PairsLvl2>().audioClip = l_Pairs[l_RandomPair].GetAudioClip(l_Pairs[l_RandomPair].audio);

                        horizontal2Arriba[_currentPair].GetComponentInChildren<ConvertFont>().Convert();

                        horizontal2Arriba[_currentPair].GetComponent<PairsLvl2>().managerOnlyOne = gameObject.GetComponent<OnlyOneManager>();

                        horizontal2Arriba[_currentPair].SetActive(true);

                        PonerColorMarco(l_Pairs[l_RandomPair].color, horizontal2Arriba[_currentPair].transform.GetChild(1).GetComponent<Image>());
                        PonerColorMarco(l_Pairs[l_RandomPair].color, horizontal2Arriba[_currentPair].transform.GetChild(2).GetComponent<Image>());
                    ...
                    else
                    {
                        ...
                        horizontal2Arriba[_currentPair].GetComponent<PairsLvl2>().nombre = l_SecondPair[l_RandomPair].palabraActual;

                        horizontal2Arriba[_currentPair].GetComponent<PairsLvl2>().texto.text = l_SecondPair[l_RandomPair].palabraActual;

                        horizontal2Arriba[_currentPair].GetComponent<PairsLvl2>().color = l_SecondPair[l_RandomPair].color;

                        if (GameManager.configuration.palabrasConArticulo)
                        {
                            if (l_SecondPair[l_RandomPair].actualArticulo != null)
                            {
                                horizontal2Arriba[_currentPair].GetComponent<PairsLvl2>().articulo = l_SecondPair[l_RandomPair].actualArticulo;
                                horizontal2Arriba[_currentPair].GetComponent<PairsLvl2>().audioArt = l_SecondPair[l_RandomPair].GetAudioArticulo();
                                horizontal2Arriba[_currentPair].GetComponent<PairsLvl2>().onlyArt = l_SecondPair[l_RandomPair].onlyArticulo;
                        ...
                        horizontal2Arriba[_currentPair].GetComponent<PairsLvl2>().audioClip = l_SecondPair[l_RandomPair].GetAudioClip(l_SecondPair[l_RandomPair].audio);
                        ...
                        PonerColorMarco(l_SecondPair[l_RandomPair].color, horizontal2Arriba[_currentPair].transform.GetChild(1).GetComponent<Image>());
                        PonerColorMarco(l_SecondPair[l_RandomPair].color, horizontal2Arriba[_currentPair].transform.GetChild(2).GetComponent<Image>());
                ...
                case 3:
                    if (_firstTime)
                    {
                        ...
                        if (GameManager.configuration.palabrasConArticulo)
                        {
                            if (l_Pairs[l_RandomPair].actualArticulo != null)
                            {
                                horizontal3Arriba[_currentPair].GetComponent<PairsLvl2>().articulo = l_Pairs[l_RandomPair].actualArticulo;
                                horizontal3Arriba[_currentPair].GetComponent<PairsLvl2>().audioArt = l_Pairs[l_RandomPair].GetAudioArticulo();
                                horizontal3Arriba[_currentPair].GetComponent<PairsLvl2>().onlyArt = l_Pairs[l_RandomPair].onlyArticulo;

                            }
                        }

                        horizontal3Arriba[_currentPair].GetComponent<PairsLvl2>().Init();
                    ...
                    else
                    {
                        ...
                        if (GameManager.configuration.palabrasConArticulo)
                        {
                            if (l_SecondPair[l_RandomPair].actualArticulo != null)
                            {
                                horizontal3Arriba[_currentPair].GetComponent<PairsLvl2>().articulo = l_SecondPair[l_RandomPair].actualArticulo;
                                horizontal3Arriba[_currentPair].GetComponent<PairsLvl2>().audioArt = l_SecondPair[l_RandomPair].GetAudioArticulo();
                                horizontal3Arriba[_currentPair].GetComponent<PairsLvl2>().onlyArt = l_SecondPair[l_RandomPair].onlyArticulo;
                ...
                case 4:
                    if (_firstTime)
                    {
                        ...
                        if (GameManager.configuration.palabrasConArticulo)
                        {
                            if (l_Pairs[l_RandomPair].actualArticulo != null)
                            {
                                horizontal4Arriba[_currentPair].GetComponent<PairsLvl2>().articulo = l_Pairs[l_RandomPair].actualArticulo;
                                horizontal4Arriba[_currentPair].GetComponent<PairsLvl2>().audioArt = l_Pairs[l_RandomPair].GetAudioArticulo();
                                horizontal4Arriba[_currentPair].GetComponent<PairsLvl2>().onlyArt = l_Pairs[l_RandomPair].onlyArticulo;

                            }
                        }

                        horizontal4Arriba[_currentPair].GetComponent<PairsLvl2>().Init();
                    ...
                    else
                    {
                        ...
                        if (GameManager.configuration.palabrasConArticulo)
                        {
                            if (l_SecondPair[l_RandomPair].actualArticulo != null)
                            {
                                horizontal4Arriba[_currentPair].GetComponent<PairsLvl2>().articulo = l_SecondPair[l_RandomPair].actualArticulo;
                                horizontal4Arriba[_currentPair].GetComponent<PairsLvl2>().audioArt = l_SecondPair[l_RandomPair].GetAudioArticulo();
                                horizontal4Arriba[_currentPair].GetComponent<PairsLvl2>().onlyArt = l_SecondPair[l_RandomPair].onlyArticulo;
            ...
            switch (_numofPairs)
            {
                case 2:
                    if (_firstTime)
                    {
                        ...
                        vertical2Left[_currentPair].GetComponent<PairsLvl2>().nombre = l_Pairs[l_RandomPair].palabraActual;

                        vertical2Left[_currentPair].GetComponent<PairsLvl2>().texto.text = l_Pairs[l_RandomPair].palabraActual;


                        vertical2Left[_currentPair].GetComponent<PairsLvl2>().color = l_Pairs[l_RandomPair].color;

                        if (GameManager.configuration.palabrasConArticulo)
                        {
                            if (l_Pairs[l_RandomPair].actualArticulo != null)
                            {
                                vertical2Left[_currentPair].GetComponent<PairsLvl2>().articulo = l_Pairs[l_RandomPair].actualArticulo;
                                vertical2Left[_currentPair].GetComponent<PairsLvl2>().audioArt = l_Pairs[l_RandomPair].GetAudioArticulo();
                                vertical2Left[_currentPair].GetComponent<PairsLvl2>().onlyArt = l_Pairs[l_RandomPair].onlyArticulo;

                            }
                        }
                        vertical2Left[_currentPair].GetComponent<PairsLvl2>().Init();


                        vertical2Left[_currentPair].GetComponent<PairsLvl2>().audioClip = l_Pairs[l_RandomPair].GetAudioClip(l_Pairs[l_RandomPair].audio);

                        vertical2Left[_currentPair].GetComponentInChildren<ConvertFont>().Convert();

                        vertical2Left[_currentPair].GetComponent<PairsLvl2>().managerOnlyOne = gameObject.GetComponent<OnlyOneManager>();

                        vertical2Left[_currentPair].SetActive(true);

                        PonerColorMarco(l_Pairs[l_RandomPair].color, vertical2Left[_currentPair].transform.GetChild(1).GetComponent<Image>());
                        PonerColorMarco(l_Pairs[l_RandomPair].color, vertical2Left[_currentPair].transform.GetChild(2).GetComponent<Image>());
                    ...
                    else
                    {
                        ...
                        vertical2Left[_currentPair].GetComponent<PairsLvl2>().nombre = l_SecondPair[l_RandomPair].palabraActual;

                        vertical2Left[_currentPair].GetComponent<PairsLvl2>().texto.text = l_SecondPair[l_RandomPair].palabraActual;


                        vertical2Left[_currentPair].GetComponent<PairsLvl2>().color = l_SecondPair[l_RandomPair].color;

                        if (GameManager.configuration.palabrasConArticulo)
                        {
                            if (l_SecondPair[l_RandomPair].actualArticulo != null)
                            {
                                vertical2Left[_currentPair].GetComponent<PairsLvl2>().articulo = l_SecondPair[l_RandomPair].actualArticulo;
                                vertical2Left[_currentPair].GetComponent<PairsLvl2>().audioArt = l_SecondPair[l_RandomPair].GetAudioArticulo();
                                vertical2Left[_currentPair].GetComponent<PairsLvl2>().onlyArt = l_SecondPair[l_RandomPair].onlyArticulo;
                        ...
                        vertical2Left[_currentPair].GetComponent<PairsLvl2>().audioClip = l_SecondPair[l_RandomPair].GetAudioClip(l_SecondPair[l_RandomPair].audio);
                        ...
                        PonerColorMarco(l_SecondPair[l_RandomPair].color, vertical2Left[_currentPair].transform.GetChild(1).GetComponent<Image>());
                        PonerColorMarco(l_SecondPair[l_RandomPair].color, vertical2Left[_currentPair].transform.GetChild(2).GetComponent<Image>());
                ...
                case 3:
                    if (_firstTime)
                    {
                        ...
                        if (GameManager.configuration.palabrasConArticulo)
                        {
                            if (l_Pairs[l_RandomPair].actualArticulo != null)
                            {
                                vertical3Left[_currentPair].GetComponent<PairsLvl2>().articulo = l_Pairs[l_RandomPair].actualArticulo;
                                vertical3Left[_currentPair].GetComponent<PairsLvl2>().audioArt = l_Pairs[l_RandomPair].GetAudioArticulo();
                                vertical3Left[_currentPair].GetComponent<PairsLvl2>().onlyArt = l_Pairs[l_RandomPair].onlyArticulo;

                            }
                        }
                        vertical3Left[_currentPair].GetComponent<PairsLvl2>().Init();
                    ...
                    else
                    {
                        ...
                        if (GameManager.configuration.palabrasConArticulo)
                        {
                            if (l_SecondPair[l_RandomPair].actualArticulo != null)
                            {
                                vertical3Left[_currentPair].GetComponent<PairsLvl2>().articulo = l_SecondPair[l_RandomPair].actualArticulo;
                                vertical3Left[_currentPair].GetComponent<PairsLvl2>().audioArt = l_SecondPair[l_RandomPair].GetAudioArticulo();
                                vertical3Left[_currentPair].GetComponent<PairsLvl2>().onlyArt = l_SecondPair[l_RandomPair].onlyArticulo;
                ...
                case 4:
                    if (_firstTime)
                    {
                        ...
                        if (GameManager.configuration.palabrasConArticulo)
                        {
                            if (l_Pairs[l_RandomPair].actualArticulo != null)
                            {
                                vertical4Left[_currentPair].GetComponent<PairsLvl2>().articulo = l_Pairs[l_RandomPair].actualArticulo;
                                vertical4Left[_currentPair].GetComponent<PairsLvl2>().audioArt = l_Pairs[l_RandomPair].GetAudioArticulo();
                                vertical4Left[_currentPair].GetComponent<PairsLvl2>().onlyArt = l_Pairs[l_RandomPair].onlyArticulo;

                            }
                        }

                        vertical4Left[_currentPair].GetComponent<PairsLvl2>().Init();
                    ...
                    else
                    {
                        ...
                        if (GameManager.configuration.palabrasConArticulo)
                        {
                            if (l_SecondPair[l_RandomPair].actualArticulo != null)
                            {
                                vertical4Left[_currentPair].GetComponent<PairsLvl2>().articulo = l_SecondPair[l_RandomPair].actualArticulo;
                                vertical4Left[_currentPair].GetComponent<PairsLvl2>().audioArt = l_SecondPair[l_RandomPair].GetAudioArticulo();
                                vertical4Left[_currentPair].GetComponent<PairsLvl2>().onlyArt = l_SecondPair[l_RandomPair].onlyArticulo;
            ...
            switch (_numofPairs)
            {
                case 2:
                    if (_firstTime)
                    {
                        ...
                        PonerColorMarco(l_Pairs[l_RandomPair].color, horizontal2Abajo[numJ].transform.GetChild(2).GetComponent<Image>());
                    ...
                    else
                    {
                        ...
                        PonerColorMarco(l_SecondPair[l_RandomPair].color, horizontal2Abajo[numJ].transform.GetChild(2).GetComponent<Image>());
            ...
            switch (_numofPairs)
            {
                case 2:
                    ...
                    if (_firstTime)
                    {
                        ...
                        PonerColorMarco(l_Pairs[l_RandomPair].color, vertical2Right[numJ].transform.GetChild(2).GetComponent<Image>());
                    ...
                    else
                    {
                        ...
                        PonerColorMarco(l_SecondPair[l_RandomPair].color, vertical2Right[numJ].transform.GetChild(2).GetComponent<Image>());
